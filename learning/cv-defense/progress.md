...
**Phase 1 tracker.** This is the single exam record while Phase 1 runs.
Phase 2 module mastery is tracked separately in `../project-knowledge-base/progress.md`.
_Rewritten each session, never appended._

**The coverage gate** (`roadmap.md`): **M** = stated the mechanism · **F** = survived 2 follow-ups ·
**B** = landed the boundary sentence. All three, closed-book, no freeze.
**Confidence /5** = your read, not a grade: 1 no idea · 2 shaky · 3 basics · 4 confident + follow-ups · 5 could teach it.

Status: ☐ not started · ⏳ in progress · ✅ covered · ⚠ thin — logged, swept at D60.

## Phase 1 — CV surface

| # | Drill | Status | M | F | B | Conf /5 | Gaps |
|---|---|:--:|:--:|:--:|:--:|:--:|---|
| 1 | **D00** Opener | ☐ | — | — | — | — | — |
...
| 7 | **D12** DentScribe 🔴 pipeline + writeback | ☐ | — | — | — | — | — |
| 8 | **D70** MyWorkMyDay | ☐ | — | — | — | — | — |
...
**D11 retired 2026-07-31** — it drilled the 40% bundle claim and the 95+ CWV claim, both deleted from
the CV on 2026-07-24. See `roadmap.md`.

### Carried into D20 from the kb test of 2026-07-30

The Dwellworks Module 0 test ran under the old kb loop and scored 6.8 (re-queue). Under the coverage
gate that is a **pass with logged gaps**, not a re-take. These five get re-asked inside D20 and nowhere else:

- **The Order is the central entity.** He listed services instead. This is the one that matters most.
- Answered *"Relocation Management"* as the product — that's the **RMC's business**, not the platform's.
- Placed home-finding and school-finding **during** the assignment; both are **before** it.
- **D12** — no flow, no boundary; deflected to *"we have React on the ClientAPI side."*
- **A3** authorization = the client's formal approval, **not** transferee onboarding. **B5** — named the
  payer but never the payer/user split.
...
Fed by real interviews and by the JD in front of you. Nothing enters until D60 passes.

| Date | Source (company / round / JD) | What it punished | Where the depth lives |
|---|---|---|---|
| — | — | — | — |

## Mock log (D60 and beyond)

| Date | Scenario | Froze on | Notes |
|---|---|---|---|
| — | — | — | — |
